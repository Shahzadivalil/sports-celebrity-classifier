...
def get_cropped_image_if_2_eyes(image_path, image_base64_data):
    haarcascade_path = "C:\Sports_Celebraity_Classifier\model\opencv\haarcascade"
...
def get_b64_test_image_for_virat_kohli():
    with open("b641.txt") as f:
        return f.read()

if __name__ == '__main__':
    load_saved_artifacts()

    print(classify_image(get_b64_test_image_for_virat_kohli(), None))
